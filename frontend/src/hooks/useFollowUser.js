...
import { useFollowUser, useUnfollowUser, useGetProfile } from '../lib/react-query/queriesAndMutation.js'
...
export const useFollowUserLogic = (targetUser) => {
   ...
   const handleFollow = async () => {
      ...
      try {
         ...
         toast.success(`You are now following ${targetUser.name || targetUser.username}`)
