...
} from '../schemas/settingsFormSchema.js'
import {
  Form,
  FormControl,
  FormDescription,
  ...
  const onSubmit = async values => {
    try {
      ...
      const updateData = {
        ...
        'academic.currentSemester': values.currentSemester
          ? parseInt(values.currentSemester)
          : null,
        'academic.graduationYear': values.graduationYear
                  ...
                  render={({ field }) => (
                    <FormItem className='flex flex-row items-center space-x-3 space-y-0'>
                      ...
                      <div className='space-y-1 leading-none'>
                        <FormLabel>New notes from people you follow</FormLabel>
                      </div>
                    </FormItem>
                  )}
                />
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem className='flex flex-row items-center space-x-3 space-y-0'>
                      ...
                      <div className='space-y-1 leading-none'>
                        <FormLabel>Comments on your notes</FormLabel>
                      </div>
                    </FormItem>
                  )}
                />
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem className='flex flex-row items-center space-x-3 space-y-0'>
                      ...
                      <div className='space-y-1 leading-none'>
                        <FormLabel>Likes on your notes</FormLabel>
                      </div>
                    </FormItem>
                  )}
                />
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem className='flex flex-row items-center space-x-3 space-y-0'>
                      ...
                      <div className='space-y-1 leading-none'>
                        <FormLabel>Weekly digest of new notes</FormLabel>
                      </div>
                    </FormItem>
                  )}
                />
            ...
            <div className='border-t pt-6'>
              <div className='flex items-center justify-between'>
                <div className='text-sm text-gray-500'>
                  ...
                  {updateLoading && <span>Saving your changes...</span>}
                </div>
