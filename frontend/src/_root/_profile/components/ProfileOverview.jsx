      ...
      <CardContent className='p-3 sm:p-4 lg:p-6'>
        <div className='flex items-center justify-between'>
          <div className='min-w-0 flex-1'>
            ...
            <p
              className={`text-lg sm:text-xl lg:text-2xl font-bold text-${color}-600`}
            >
              {value || 0}
            </p>
          </div>
          <div
            className={`text-2xl sm:text-3xl text-${color}-500 flex-shrink-0 ml-2`}
          >
            {icon}
          </div>
        </div>
    ...
    <div className='space-y-4 sm:space-y-6'>
      ...
      <div className='grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 lg:gap-6'>
        <StatCard
          ...
          value={
            statsData?.success
              ? statsData.data.overview.totalNotes
              : user.activity.totalUploads
          }
        ...
        <StatCard
          ...
          value={
            statsData?.success
              ? statsData.data.overview.totalDownloads
              : user.activity.totalDownloads
          }
          icon={<CloudDownload className='h-4 w-4 sm:h-5 sm:w-5' />}
          color='green'
        />
        <StatCard
          title='Total Views'
        ...
        <StatCard
          ...
          value={
            statsData?.success
              ? statsData.data.overview.avgRating?.toFixed(1)
              : '0.0'
          }
