         ...
         <div className='flex justify-between items-center mt-6'>
            ...
            <div className='flex space-x-2'>
               ...
               <button
                  ...
                  className='px-3 py-2 bg-red-500 text-white rounded disabled:opacity-50 disabled:cursor-not-allowed hover:bg-red-600'
               >
                  Next
               </button>
            </div>
      ...
      return (
         <div className='bg-white rounded-lg shadow-lg p-6'>
            <div className='text-center py-8'>
               <p className='text-red-600 mb-4'>Error loading your favorites: {error.message}</p>
               <button
      ...
      <div className='space-y-6'>
         ...
         <div className='bg-white rounded-lg shadow-lg p-6'>
            <div className='flex justify-between items-center mb-4'>
               <h2 className='text-2xl font-bold text-gray-900'>My Favorite Notes</h2>
