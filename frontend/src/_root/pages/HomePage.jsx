            ...
            <div className='mb-12'>
              ...
              <div className='flex justify-center items-center'>
                ...
                <div className='ml-4 text-left'>
                  <a
                    href={teamMembers[0]?.links?.portfolio || '#'}
                    target='_blank'
                    rel='noopener noreferrer'
                    className='text-sm font-medium text-gray-900 hover:underline'
                  >
                    {teamMembers[0]?.name || 'Developer'}
                  </a>
                  <p className='text-xs text-gray-500'>
                    {teamMembers[0]?.role || 'Building the future of note sharing'}
                  </p>
                  <div className='flex gap-2 mt-1'>
                    ...
                    {teamMembers[0]?.links?.twitter && (
                      <a
                        href={teamMembers[0].links.twitter}
                        target='_blank'
                        rel='noopener noreferrer'
